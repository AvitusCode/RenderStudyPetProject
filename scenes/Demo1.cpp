...
void Demo1::OnCreate()
{
	...
	vertexComponent.loadComponentFromFile("res/phongShader/phong.vert", GL_VERTEX_SHADER);
	fragmentComponent.loadComponentFromFile("res/phongShader/phong.frag", GL_FRAGMENT_SHADER);
	materialComp.loadComponentFromFile("res/lightShaders/material.frag", GL_FRAGMENT_SHADER);
	DirComp.loadComponentFromFile("res/lightShaders/dirLight.frag", GL_FRAGMENT_SHADER);
	PointComp.loadComponentFromFile("res/lightShaders/pointLight.frag", GL_FRAGMENT_SHADER);
	SpotComp.loadComponentFromFile("res/lightShaders/spotLight.frag", GL_FRAGMENT_SHADER);
	FogComp.loadComponentFromFile("res/fogShader/fog.frag", GL_FRAGMENT_SHADER);
	...
	AssimpModel amodel = loadModel("res/objects/house/medieval_house.obj");
	...
	textureManager.loadTexture2D("terrain", "res/Scene1/sand.png", "texture_diffuse");
	makeTerrain("res/Scene1/heightMap.png", terrainMesh, terrainRend);
	...
	// Skybox
	entity = engine.CreateEntity();
	SkyboxComponent skyComponent = loadSkybox("res/skybox/desert/");
